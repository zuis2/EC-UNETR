...
from models.unetr_pp.layers import LayerNorm
from models.unetr_pp.transformerblock import TransformerBlock
from models.unetr_pp.dynunet_block import get_conv_layer, UnetResBlock


einops, _ = optional_import("einops")

class UnetrPPEncoder(nn.Module):
    def __init__(self, input_size=[72 * 72 * 72, 36 * 36 * 36, 18 * 18 * 18, 9 * 9 * 9],dims=[32, 64, 128, 256],
