...
class RG_UNETR_Grid(nn.Module):
    ...
    def __init__(
        ...
        self.out_5 = GridOutBlock(spatial_dims=3, in_channels=feature_size * 2, out_channels=out_channels, upsample_stride=2)
        self.out_6 = GridOutBlock(spatial_dims=3, in_channels=feature_size * 4, out_channels=out_channels, upsample_stride=4)
    ...
    def forward(self, x_in):
        ...
        out = (out_1 + out_2 +out_3 + out_4 + out_5 + out_6) / 6 #1*(48)
        return out
